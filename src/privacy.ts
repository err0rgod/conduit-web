...
export const privacySections: PrivacySection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "The Chromium debugging capability can receive page console messages, uncaught exception metadata, network request/response metadata, pause events, and bounded performance trace data for a tab explicitly selected by the user. Chromium requires the debugger permission at extension installation time; Conduit still requires the separate browser.debug daemon capability. Diagnostic buffers are held in memory and redact request bodies, cookies, authorization headers, passwords, tokens, and other secret-like fields by default. Runtime evaluation is high-risk and confirmation-protected.",
    ],
  },
  {
